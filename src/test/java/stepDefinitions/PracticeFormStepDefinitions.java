...
public class PracticeFormStepDefinitions {
    ...
    public void username_password_ve_textarea_kisimlarini_doldurur(String username, String password, String textarea) {
        ...
        practiceFormPage.usernameBox.sendKeys(username);
        practiceFormPage.passwordBox.sendKeys(password);
    ...
    public void bir_dosya_yukler() {
        practiceFormPage.chooseFile.sendKeys("C:\\Users\\yturk\\OneDrive\\Masaüstü\\text.txt");

      //  String homeDirectory= System.getProperty("user.home");
      //  String filePath = homeDirectory+"\\Masaüstü\\\\text.txt";
